...
import 'package:our_companion_app/features/auth/data/repository/auth_repository.dart';
...
class SignupNotifier extends Notifier<SignupState> {
  ...
  Future<void> signInWithGoogle(void Function(String message) onSuccess) async {
    state = state.copyWith(isLoading: true);
